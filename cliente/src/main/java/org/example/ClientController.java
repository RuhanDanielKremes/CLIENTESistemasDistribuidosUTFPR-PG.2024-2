...
public class ClientController extends Thread{
    ...
    public static void testserver(BufferedReader reader, PrintWriter writer) throws IOException {
        String json2 = "{\"operacao\": \"cadastrarUsuario\", \"ra\": \"2524198\", \"senha\": \"essaehasenha\", \"nome\": \"FULANODASILVA\"}";
        String json1 = "{\"operacao\": \"login\", \"ra\": \"2524198\", \"senha\": \"essaehasenha\"}";
        // String json3 = "{\"operacao\": \"listarUsuarios\", \"token\":\"2524198\"}";
        String json3 = "{\"operacao\": \"listarUsuarios\", \"token\":\"2524198\"}";
        String json4 = "{\"operacao\": \"localizarUsuario\", \"token\":\"2524198\", \"ra\": \"2524198\"}";
        String json6 = "{\"operacao\": \"editarUsuario\", \"token\":\"2524198\", \"usuario\": {\"ra\": \"2524198\", \"senha\": \"essaehasenha\", \"nome\": \"SILVA FULANO\"}}";

        // CRUD Categoria
        String salvarCategoria = "{ \"operacao\": \"salvarCategoria\", \"token\": \"2458969\", \"categoria\": { \"id\": 0, \"nome\": \"NOME DA CATEGORIA\" } }";
        String listarCategorias = "{ \"operacao\": \"listarCategorias\", \"token\": \"2524198\" }";
        String localizarCategoria = "{ \"operacao\": \"localizarCategoria\", \"token\": \"2524198\", \"id\": 9 }";
        ...
        String excluirCategoria = "{ \"operacao\": \"excluirCategoria\", \"token\": \"2458969\", \"id\": 9}";

        String json19 = "{\"operacao\": \"logout\", \"token\":\"2524198\"}";
        String json5 = "{\"operacao\": \"excluirUsuario\", \"token\":\"2458969\", \"ra\": \"2524198\"}";
        ...
        // String JsonComCampoAmais = "{ \"operacao\": \"salvarCategoria\", \"token\": \"2458969\", \"categoria\": { \"id\": 9, \"nome\": \"NOME DA CATEGORIA\" }, \"user\":0 }";
        // writer.println(JsonComCampoAmais);
